...
def main():
    ...
    cameras = [
        {"name": "cam1", "url": "rtsp://admin:admin@192.168.10.101:554/video", "topic": "/camera1/color/image_raw/compressed"},
        {"name": "cam2", "url": "rtsp://admin:admin@192.168.10.102:554/video", "topic": "/camera2/color/image_raw/compressed"},
        {"name": "cam3", "url": "rtsp://admin:admin@192.168.10.103:554/video", "topic": "/camera3/color/image_raw/compressed"},
        {"name": "cam4", "url": "rtsp://admin:admin@192.168.10.104:554/video", "topic": "/camera4/color/image_raw/compressed"},
    ]
